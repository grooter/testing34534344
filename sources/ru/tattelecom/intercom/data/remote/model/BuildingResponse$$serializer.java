...
public final class BuildingResponse$$serializer implements GeneratedSerializer<BuildingResponse> {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("ru.tattelecom.intercom.data.remote.model.BuildingResponse", buildingResponse$$serializer, 3);
        ...
        pluginGeneratedSerialDescriptor.addElement(EntitiesKt.STREAM_TABLE, true);
    ...
    public KSerializer<?>[] childSerializers() {
        ...
        kSerializerArr = BuildingResponse.$childSerializers;
        return new KSerializer[]{BuiltinSerializersKt.getNullable(IntSerializer.INSTANCE), BuiltinSerializersKt.getNullable(StringSerializer.INSTANCE), BuiltinSerializersKt.getNullable(kSerializerArr[2])};
    }

    @Override // kotlinx.serialization.DeserializationStrategy
    public BuildingResponse deserialize(Decoder decoder) {
        KSerializer[] kSerializerArr;
        int i;
        Integer num;
        String str;
        ...
        return new BuildingResponse(i, num, str, list, (SerializationConstructorMarker) null);
    }
    ...
    public void serialize(Encoder encoder, BuildingResponse value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder beginStructure = encoder.beginStructure(descriptor2);
        BuildingResponse.write$Self$data_release(value, beginStructure, descriptor2);
        beginStructure.endStructure(descriptor2);
    }
