...
@DebugMetadata(c = "ru.tattelecom.intercom.feature.home.HomeListFragment$onViewCreated$16$2", f = "HomeListFragment.kt", i = {}, l = {84}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes6.dex */
final class HomeListFragment$onViewCreated$16$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ HomeListFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    HomeListFragment$onViewCreated$16$2(HomeListFragment homeListFragment, Continuation<? super HomeListFragment$onViewCreated$16$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new HomeListFragment$onViewCreated$16$2(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((HomeListFragment$onViewCreated$16$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Flow<List<HomeItem>> intercomList = viewModel.getIntercomList();
            final HomeListFragment homeListFragment = this.this$0;
            this.label = 1;
            if (intercomList.collect(new FlowCollector() { // from class: ru.tattelecom.intercom.feature.home.HomeListFragment$onViewCreated$16$2.1
                ...
                public final Object emit(List<? extends HomeItem> list, Continuation<? super Unit> continuation) {
                    ...
                    binding2.textView2.setText(HomeListFragment.this.getString(R.string.empty_intercoms));
